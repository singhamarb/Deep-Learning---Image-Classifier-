# Intro to Machine Learning using PyTorch NanoDegree
## Deep Learning
...
### License, Acknowledgement & Author:
This project was done by Amar singh during the Intro to ML nanodegree offered by Udacity and the data was gathered from site (http://www.robots.ox.ac.uk/~vgg/data/flowers/102/index.html)
